...
{
    internal class WebPackageItem : APrefab<WebPackageItem>
    {
        private static void _init()
        {
            GameObject obj = new GameObject("WebPackageItem", typeof(Image), typeof(Button));
            ...
            Prefab = obj.AddComponent<WebPackageItem>();
        }
        [Hotfixable]
        protected override void Init()
        {
            ...
            GetComponent<Button>().onClick.AddListener(() => {
                CN_PackageSelectWindow.Instance.SelectPackage(Meta);
            });
